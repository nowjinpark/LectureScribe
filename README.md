...
| Zoom 앱 캡처 | **1.2.0 설치본**에서 Zoom의 스피커 테스트 소리를 직접 캡처. 84.5초 M4A에서 약 50~68초 소리, 48 kHz 스테레오·오디오 1트랙·영상 0트랙 확인 |
...
전사 비교는 제한된 합성 음성의 결과이며 실제 강의의 정확도를 보장하지 않습니다. 1.2.0 설치본에서 Zoom 녹음 시작·소리 수집·파일 저장을 확인했습니다. 기존 QuickTime 캡처본도 설치본에서 다시 변환해 4문장과 원본 시간 정보, TXT·SRT 저장을 확인했습니다. 실제 원격 수업의 녹음부터 전사까지 이어지는 검사는 아직 수행하지 않았습니다.
